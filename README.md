...
I build resilient web platforms, cross-platform mobile ecosystems, and asynchronous backend microservices — with a focus on real-time WebSocket state sync, distributed worker queues, and automated data pipelines that don't fall over in production.
